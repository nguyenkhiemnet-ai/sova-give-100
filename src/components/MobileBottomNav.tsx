...
export default function MobileBottomNav() {
  ...
  // Ẩn vĩnh viễn thanh điều hướng chung trên mobile tại trang /create-wish
  const isCreateWish = 
    (typeof window !== 'undefined' && window.location.pathname.includes('/create-wish')) ||
    pathname?.startsWith('/create-wish');
  ...
  return (
    <div className="md:hidden fixed bottom-0 left-0 right-0 z-40 bg-white/95 backdrop-blur-lg border-t border-warm-200 px-2 py-1 shadow-lg">
