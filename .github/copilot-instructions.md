...
- **Lead UI/UX Engineer**: Công thái học ngón tay cái, Floating Action Dock cố định z-[60] trên mobile, giữ nguyên tỉ lệ ảnh gốc không méo, CLS = 0, ẩn MobileBottomNav tại /create-wish.
...
## CÔNG THÁI HỌC BIỂU MẪU & NÉN ẢNH
...
- Kiểm toán giao diện Chrome thật: `scripts/audit_chrome_autonomous.mjs`.
